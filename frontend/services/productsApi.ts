    ...
    endpoints: (builder) => ({
        ...
        getFilters: builder.query<FilterOptions, void>({
            ...
            transformResponse: (response: { filters?: FilterOptions }) => ({
                ...
                categoryCounts: response.filters?.categoryCounts ?? {},
                brandCounts: response.filters?.brandCounts ?? {},
                colourCounts: response.filters?.colourCounts ?? {},
                sizeCounts: response.filters?.sizeCounts ?? {},
