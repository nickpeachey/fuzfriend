            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between gap-4">
                    ...
                    <div className="relative min-w-12">
                        <Link href="/cart" prefetch={false} aria-label="Cart" className="relative inline-flex items-center rounded px-3 py-2 text-zinc-800 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800">
